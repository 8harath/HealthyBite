...
export default function MealPlanPage() {
    ...
    const generateWeeklyPlan = useCallback((meals: MealRecommendation[]) => {
        ...
        DAYS.forEach((day) => {
            ...
            MEAL_TYPES.forEach((type) => {
                // Filter meals that match this type tag, fallback to cycling through all
    ...
    useEffect(() => {
        ...
        // Fetch recommendations for meal plan
        const fetchMeals = async () => {
            try {
                ...
                if (response.ok) {
                    ...
                    const plan = generateWeeklyPlan(data.recommendations || []);
                    setWeeklyPlan(plan);
                }
            } catch (error) {
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mt-1">
                            Click any meal to swap it with an alternative
                        </p>
                    </div>
